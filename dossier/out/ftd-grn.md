# Indication dossier — Frontotemporal dementia with GRN mutations (FTD-GRN)

Spine generated from the persona question bank (v0). 31 questions fire for tags: genetic-medicine, cns; 2 modality-specific questions not applicable.
...
#### 25. Who else is working on this, how far ahead are they, and what would we have that they do not?
...
#### 26. If this is such a good idea, why has nobody done it? Name the specific barrier, and say what changed to remove it.
...
### Execution — CMC, durability, manufacturability, cost

#### 27. For a one-shot genetic medicine — how long does the effect last, can it be redosed, and what does pre-existing immunity do to eligibility?

*Katherine High / Fyodor Urnov*

**Where to look**
- [ ] AAV serostatus prevalence
- [ ] durability data in class
- [ ] redosing precedent
...
<sub>source: Spark/AskBio gene therapy programs; IGI translational work</sub>

---

#### 28. Can this be made at the scale and cost the indication requires, and is the process a research process or a manufacturable one?

*Carl June / Steven Rosenberg*

**Where to look**
- [ ] COGS precedent in class
- [ ] vein-to-vein time
- [ ] CMC precedent
...
<sub>source: CAR-T manufacturing experience at Penn and NCI</sub>
